...
class _search_screenState extends State<search_screen> {
  ...
  Widget build(BuildContext context) {
    ...
    List<product> products = products1.where((element) => element.title == _textEditingController.text).toList();
    return Scaffold(
      appBar: AppBar(
        title: Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(contentPadding: EdgeInsets.all(10),hintText: "Search", ),
          ),
        ),
      ),
